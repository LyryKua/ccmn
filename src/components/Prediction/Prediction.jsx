...
class Prediction extends Component {
  state = {
    range: {
      // startDate, endDate
      date: moment(subMonths(new Date(), 3)).format('YYYY-MM-DD'),
    },
  ...
  handleChangeDate = (start, end) => {
    const startDate = moment(subMonths(start, 3)).format('YYYY-MM-DD');
    const endDate = moment(subMonths(end, 3)).format('YYYY-MM-DD');
    this.setState({
